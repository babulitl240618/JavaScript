...
AppController.prototype.hangup_ = function() {
  ...
  socket.emit('call_hangup', { hangup_id : hangup_id });

  socket.emit('userbusy_dbup', { user_id : user_id , is_busy : 0 });
...
PeerConnectionClient.prototype.onIceConnectionStateChanged_ = function() {
  ...
  if(this.pc_.iceConnectionState=='connected'){
    ...
    socket.emit('userbusy_dbup', { user_id : user_id , is_busy : 1 });
  }else if(this.pc_.iceConnectionState=='closed'){
